...
#### Предусловия:
1.Открыть страницу в браузере. В браузере должна отобразиться  страница с заголовком “Путешествие дня”.
 [screenshot](скриншот MainPage).
2. На главной странице найти кнопку “Купить”, нажать ее. Под кнопкой “Купить” должна появиться форма для заполнения “Оплата по карте”.
#### Выполненные шаги:
